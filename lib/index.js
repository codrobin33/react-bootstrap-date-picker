...
var DatePickerHeader = function (_React$Component) {
  ...
  function DatePickerHeader() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = DatePickerHeader.__proto__ || Object.getPrototypeOf(DatePickerHeader)).call.apply(_ref, [this].concat(args))), _this), _this.displayingMinMonth = function () {
...
var DatePickerCalendar = function (_React$Component2) {
  ...
  function DatePickerCalendar() {
    ...
    return _ret2 = (_temp2 = (_this2 = _possibleConstructorReturn(this, (_ref2 = DatePickerCalendar.__proto__ || Object.getPrototypeOf(DatePickerCalendar)).call.apply(_ref2, [this].concat(args))), _this2), _this2.handleClick = function (e) {
      ...
      for (var i = 0; i < 9; i++) {
        ...
        for (var j = 0; j <= 6; j++) {
          if (day <= monthLength && (i > 0 || j >= startingDay)) {
            ...
            week.push(_react2.default.createElement('td', { key: i + '-' + j }));
          }
        }
...
var DatePicker = function (_React$Component3) {
  ...
  function DatePicker(props) {
    ...
    _this4.makeDateValues = function (isoString) {
      var displayDate = void 0;
      var selectedDate = isoString ? new Date(isoString.slice(0, 10) + 'T12:00:00.000Z') : null;
      var minDate = _this4.props.minDate ? new Date(_this4.props.minDate.slice(0, 10) + 'T12:00:00.000Z') : null;
      var maxDate = _this4.props.maxDate ? new Date(_this4.props.maxDate.slice(0, 10) + 'T12:00:00.000Z') : null;

      var inputValue = isoString ? _this4.makeInputValueString(selectedDate) : null;
      if (selectedDate) {
    ...
    _this4.handleHide = function () {
      ...
      if (_this4.props.onBlur) {
        ...
        _reactDom2.default.findDOMNode(_this4.refs.hiddenInput).dispatchEvent(event);
    ...
    _this4.shouldComponentUpdate = function (nextProps, nextState) {
      return !(_this4.state.inputFocused === true && nextState.inputFocused === false);
    };

    _this4.getValue = function () {
      return _this4.state.selectedDate ? _this4.state.selectedDate.toISOString() : null;
    };

    _this4.getFormattedValue = function () {
      return _this4.state.displayDate ? _this4.state.inputValue : null;
    };

    _this4.getCalendarPlacement = function () {
    ...
    _this4.makeInputValueString = function (date) {
      var month = date.getMonth() + 1;
      var day = date.getDate();

      //this method is executed during intialState setup... handle a missing state properly
      var separator = _this4.state ? _this4.state.separator : _this4.props.dateFormat.match(/[^A-Z]/)[0];
    ...
    _this4.handleBadInput = function (originalValue) {
      var parts = originalValue.replace(new RegExp('[^0-9' + _this4.state.separator + ']'), '').split(_this4.state.separator);
      if (_this4.props.dateFormat.match(/MM.DD.YYYY/) || _this4.props.dateFormat.match(/DD.MM.YYYY/)) {
    ...
    _this4.handleInputChange = function () {

      var originalValue = _reactDom2.default.findDOMNode(_this4.refs.input).value;
      var inputValue = originalValue.replace(/(-|\/\/)/g, _this4.state.separator).slice(0, 10);
    ...
    _this4.onChangeMonth = function (newDisplayDate) {
      _this4.setState({
        displayDate: newDisplayDate
      });
    };

    _this4.onChangeDate = function (newSelectedDate) {
    ...
    _this4.componentWillReceiveProps = function (newProps) {
      var value = newProps.value;
      if (_this4.getValue() !== value) {
        _this4.setState(_this4.makeDateValues(value));
      }
    };
    ...
    var defaultState = _this4.makeDateValues(props.value || props.defaultValue);
    if (props.weekStartsOn > 1) {
      defaultState.dayLabels = props.dayLabels.slice(props.weekStartsOn).concat(props.dayLabels.slice(0, props.weekStartsOn));
